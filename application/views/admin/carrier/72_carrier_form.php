          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Carrier <?php echo $button ?></h5>
              </div>
              <div class="card-body">
                <form action="<?php echo $action; ?>" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-1">
                        <div class="form-group">
                            <label for="varchar">Carco <?php echo form_error('carco') ?></label>
                            <input type="text" class="form-control" name="carco" id="carco" placeholder="Carco" value="<?php echo $carco; ?>" />
                        </div>
                    </div>
                    <div class="col-md-4 pr-1">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 px-1">
                        <div class="form-group">
                            <label for="int">Del <?php echo form_error('del') ?></label>
                            <input type="text" class="form-control" name="del" id="del" placeholder="Del" value="<?php echo $del; ?>" />
                        </div>
                    </div>
                  </div>
                    <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
                    <button type="submit" class="btn btn-success"><?php echo $button ?></button> 
                    <a href="<?php echo site_url('carrier') ?>" class="btn btn-default">Cancel</a>
                </form>
              </div>
            </div>
          </div>
